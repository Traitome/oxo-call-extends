...
category: hpc
description: netCDF-C library with MVAPICH 4.0 and UCX for high-performance parallel I/O in scientific applications.
tags: [esme_netcdf-c_mvapich_4_0_ucx, netCDF, hpc, parallel, MVAPICH, UCX]
...
- **Tool Overview**: netCDF-C is the C implementation of the network Common Data Form, providing platform-independent storage for array-oriented scientific data with MVAPICH 4.0 MPI and UCX support.
...
- **Installation**: `conda install -c bioconda esme_netcdf-c_mvapich_4_0_ucx`
