...
category: hpc
description: netCDF-Fortran library with ParaStationMPI 4.3.2 for high-performance parallel I/O in scientific applications.
tags: [esme_netcdf-fortran_psmpi_4_3_2, netCDF, Fortran, hpc, parallel, ParaStationMPI]
...
- **Tool Overview**: netCDF-Fortran is the Fortran interface to netCDF, providing platform-independent storage for array-oriented scientific data with ParaStationMPI 4.3.2 support.
- **MPI Support**: Built with ParaStationMPI 4.3.2 for high-performance parallel computing on ParaStation clusters.
- **Data Formats**: Supports netCDF classic, 64-bit offset, and netCDF-4/HDF5 formats.
- **Installation**: `conda install -c bioconda esme_netcdf-fortran_psmpi_4_3_2`
...
- **MPI Environment**: Requires proper MPI environment setup with ParaStationMPI 4.3.2.
...
**Explanation:** Compile a Fortran program using netCDF-Fortran and ParaStationMPI with proper linking flags.

### Run parallel netCDF-Fortran application
**Args:** `mpiexec -n 8 ./my_program input.nc output.nc`
**Explanation:** Execute a parallel netCDF-Fortran application using 8 MPI processes with ParaStationMPI.
