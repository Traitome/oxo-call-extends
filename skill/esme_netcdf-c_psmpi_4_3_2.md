...
category: hpc
description: netCDF-C library with ParaStationMPI 4.3.2 for high-performance parallel I/O in scientific applications.
tags: [esme_netcdf-c_psmpi_4_3_2, netCDF, hpc, parallel, ParaStationMPI]
...
- **Tool Overview**: netCDF-C is the C implementation of the network Common Data Form, providing platform-independent storage for array-oriented scientific data with ParaStationMPI 4.3.2 support.
...
- **Installation**: `conda install -c bioconda esme_netcdf-c_psmpi_4_3_2`
