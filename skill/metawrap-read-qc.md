...
- **Tool Overview**: metawrap-read-qc v1.3.0 - MetaWRAP requirements for read_qc step.
- **Core Function**: MetaWRAP requirements for read_qc step
- **Input/Output**: Depends on tool function. Check documentation for details.
- **Installation**: `conda install -c bioconda metawrap-read-qc`
