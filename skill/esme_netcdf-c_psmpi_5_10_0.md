...
category: hpc
description: netCDF-C library with ParaStationMPI 5.10.0 for high-performance parallel I/O in scientific applications.
tags: [esme_netcdf-c_psmpi_5_10_0, netCDF, hpc, parallel, ParaStationMPI]
...
- **Tool Overview**: netCDF-C is the C implementation of the network Common Data Form, providing platform-independent storage for array-oriented scientific data with ParaStationMPI 5.10.0 support.
...
- **Installation**: `conda install -c bioconda esme_netcdf-c_psmpi_5_10_0`
