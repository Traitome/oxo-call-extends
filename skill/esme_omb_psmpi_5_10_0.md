...
category: utility
description: OSU Micro Benchmarks with ParaStationMPI 5.10.0 for high-performance computing performance testing.
tags: [esme_omb_psmpi_5_10_0, OSU, benchmarks, hpc, MPI, ParaStationMPI]
...
- **Installation**: `conda install -c bioconda esme_omb_psmpi_5_10_0`
- **MPI Support**: Built with ParaStationMPI 5.10.0 for benchmarking parallel computing performance on ParaStation clusters.
