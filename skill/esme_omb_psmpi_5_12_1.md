...
category: utility
description: OSU Micro Benchmarks with ParaStationMPI 5.12.1 for high-performance computing performance testing.
tags: [esme_omb_psmpi_5_12_1, OSU, benchmarks, hpc, MPI, ParaStationMPI]
...
- **Installation**: `conda install -c bioconda esme_omb_psmpi_5_12_1`
- **MPI Support**: Built with ParaStationMPI 5.12.1 for benchmarking parallel computing performance on ParaStation clusters.
