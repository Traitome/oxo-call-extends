...
tags: [dartunifrac, formatting, SAM]
...
- **Tool Overview**: dartunifrac (v0.3.0) - DartUniFrac is an ultra-fast UniFrac algorithm that scales to millions of samples. It was designed based on optimal balanced parenthesis and Weighted MinHash sketching.
...
- **Installation**: `conda install -c bioconda dartunifrac`
