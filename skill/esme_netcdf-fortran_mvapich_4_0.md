...
category: hpc
description: netCDF-Fortran library with MVAPICH 4.0 for high-performance parallel I/O in scientific applications on InfiniBand networks.
tags: [esme_netcdf-fortran_mvapich_4_0, netCDF, Fortran, hpc, parallel, MVAPICH]
...
- **Tool Overview**: netCDF-Fortran is the Fortran interface to netCDF, providing platform-independent storage for array-oriented scientific data with MVAPICH 4.0 support.
...
- **Installation**: `conda install -c bioconda esme_netcdf-fortran_mvapich_4_0`
