...
category: utility
description: OSU Micro Benchmarks with OpenMPI 4.1.6 for high-performance computing performance testing.
tags: [esme_omb_openmpi_4_1_6, OSU, benchmarks, hpc, MPI, OpenMPI]
...
- **Installation**: `conda install -c bioconda esme_omb_openmpi_4_1_6`
- **MPI Support**: Built with OpenMPI 4.1.6 for benchmarking parallel computing performance.
