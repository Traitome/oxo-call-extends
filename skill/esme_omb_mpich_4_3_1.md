...
category: utility
description: OSU Micro Benchmarks with MPICH 4.3.1 for high-performance computing performance testing.
tags: [esme_omb_mpich_4_3_1, OSU, benchmarks, hpc, MPI, MPICH]
...
- **Installation**: `conda install -c bioconda esme_omb_mpich_4_3_1`
- **MPI Support**: Built with MPICH 4.3.1 for benchmarking parallel computing performance.
