...
category: hpc
description: netCDF-Fortran library with ParaStationMPI 5.10.0 for high-performance parallel I/O in scientific applications.
tags: [esme_netcdf-fortran_psmpi_5_10_0, netCDF, Fortran, hpc, parallel, ParaStationMPI]
...
- **Tool Overview**: netCDF-Fortran is the Fortran interface to netCDF, providing platform-independent storage for array-oriented scientific data with ParaStationMPI 5.10.0 support.
...
- **Installation**: `conda install -c bioconda esme_netcdf-fortran_psmpi_5_10_0`
