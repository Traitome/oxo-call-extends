...
category: utility
description: OSU Micro Benchmarks with OpenMPI 5.0.7 for high-performance computing performance testing.
tags: [esme_omb_openmpi_5_0_7, OSU, benchmarks, hpc, MPI, OpenMPI]
...
- **Installation**: `conda install -c bioconda esme_omb_openmpi_5_0_7`
- **MPI Support**: Built with OpenMPI 5.0.7 for benchmarking parallel computing performance.
