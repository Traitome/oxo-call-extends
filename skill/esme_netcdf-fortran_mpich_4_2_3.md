...
category: hpc
description: netCDF-Fortran library with MPICH 4.2.3 for high-performance parallel I/O in scientific applications.
tags: [esme_netcdf-fortran_mpich_4_2_3, netCDF, Fortran, hpc, parallel, MPICH]
...
- **Tool Overview**: netCDF-Fortran is the Fortran interface to netCDF, providing platform-independent storage for array-oriented scientific data with MPICH 4.2.3 support.
...
- **Installation**: `conda install -c bioconda esme_netcdf-fortran_mpich_4_2_3`
