...
category: utility
description: OSU Micro Benchmarks with ParaStationMPI 4.3.2 for high-performance computing performance testing.
tags: [esme_omb_psmpi_4_3_2, OSU, benchmarks, hpc, MPI, ParaStationMPI]
...
- **Installation**: `conda install -c bioconda esme_omb_psmpi_4_3_2`
- **MPI Support**: Built with ParaStationMPI 4.3.2 for benchmarking parallel computing performance on ParaStation clusters.
